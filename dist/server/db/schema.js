...
exports.users = (0, pg_core_1.pgTable)('users', {
    ...
    gym_id: (0, pg_core_1.integer)('gym_id').references(function () { return exports.gyms.id; }),
...
exports.routes = (0, pg_core_1.pgTable)('routes', {
    id: (0, pg_core_1.serial)('id').primaryKey(),
    gym_id: (0, pg_core_1.integer)('gym_id').notNull().references(function () { return exports.gyms.id; }),
...
exports.sends = (0, pg_core_1.pgTable)('sends', {
    id: (0, pg_core_1.serial)('id').primaryKey(),
    user_id: (0, pg_core_1.integer)('user_id').notNull().references(function () { return exports.users.id; }),
    route_id: (0, pg_core_1.integer)('route_id').notNull().references(function () { return exports.routes.id; }),
