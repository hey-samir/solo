...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white shadow-inner dark:bg-gray-800 mt-auto py-8">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <Link href="/" className="flex items-center">
              ...
              />
              <span className="ml-2 text-xl font-bold text-gray-800 dark:text-white">Solo</span>
            </Link>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8">
            ...
            <div>
              ...
              <div className="mt-2 space-y-2">
                <Link href="/privacy" className="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                  Privacy
                </Link>
                <br />
                <Link href="/terms" className="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                  Terms
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2 space-y-2">
                ...
                <br />
                <Link href="/contact" className="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                  Contact
                </Link>
              </div>
            </div>
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Solo Climbing App. All rights reserved.
          </p>
